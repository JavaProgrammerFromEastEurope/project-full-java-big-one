...
public class FourthMatrixAction extends BaseAlgorithmAction implements Action {

	@Override
	public String description() {
		return "Form a square matrix\n" +
				"\tof order n according to a given pattern (n is even):\n" +
				"\tFirst variation (see pattern in the file):\n";
	}

	@Override
	public void action() {
		algorithmActions.get(2).calcFourthFunction();
	}
}
