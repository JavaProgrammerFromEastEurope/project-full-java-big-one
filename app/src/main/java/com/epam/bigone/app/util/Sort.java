...
public final class Sort {
	...
	public static Object[][] sortMatrixObjects(Object[][] matrix,
	...
	public static Object[] sortLineObjects(Object[] lineObjects,
			Comparator<Object> objectComparator) {
		lineObjects = stream(lineObjects)
				.filter(Objects::nonNull).sorted(objectComparator).toArray();
		return lineObjects;
	}
