package com.epam.bigone.receiver;
...
public class Receiver implements TCPConnectionListener {
	...
	@Override
	public void onReceiverString(CommunicationBridge tcpConnection, String value) {
		out.println(value);
	}
