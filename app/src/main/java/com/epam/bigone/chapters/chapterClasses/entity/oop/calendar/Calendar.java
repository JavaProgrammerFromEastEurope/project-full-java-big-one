package com.epam.bigone.chapters.chapterClasses.entity.oop.calendar;
...
public class Calendar {
	...
	private final Map<Integer, FreeDay> holidays = new HashMap<>();
	...
	public Map<Integer, FreeDay> getHolidays() {
		return holidays;
	}
}